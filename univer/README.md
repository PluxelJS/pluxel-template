...
- 核心前端插件（UI + 编辑器）：`univer/pluxel-plugin-univer/README.md`
- 文档/保存服务插件（workbooks）：`univer/pluxel-plugin-univer-workbooks/README.md`
- AI service 插件（Ax + TOON + ChangeSet）：`univer/pluxel-plugin-univer-ai/README.md`
